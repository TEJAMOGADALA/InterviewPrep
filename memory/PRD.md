...
- **Model default**: `gemini-flash-latest` (auto-updating alias; `gemini-2.5-flash` was deprecated by Google for new API keys, so we migrated on 2026-02-22 and switched the Settings text field to a curated dropdown of working models).
